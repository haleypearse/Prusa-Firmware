...
#define DEFAULT_MAX_ACCELERATION            {1300, 1300, 200, 5000}  // (mm/sec^2) max acceleration (M201)
#define DEFAULT_MAX_ACCELERATION_SILENT     {1000, 1000, 200, 5000}    // (mm/sec^2) max acceleration(M201), silent mode


#define DEFAULT_ACCELERATION          1400   // X, Y, Z and E max acceleration in mm/s^2 for printing moves (M204P)
#define DEFAULT_RETRACT_ACCELERATION  1400   // X, Y, Z and E max acceleration in mm/s^2 for retracts (M204R)
#define DEFAULT_TRAVEL_ACCELERATION   1400   // X, Y, Z and E max acceleration in mm/s^2 for travels (M204T)
